...
const Breadcrumbs = (props) => {
    const { crumbs } = props;
    return (React.createElement("div", { className: "breadcrumb-container" }, crumbs.map(({ title, disabled = false, action = () => null }, i) => (React.createElement(React.Fragment, { key: `${title}_${i}` },
