...
const Paging = (props) => {
    ...
    const _renderPreviousSection = () => {
        ...
        return (React.createElement("div", { onClick: prevFn, className: helpers_1.combineClassNames("paging_controller-button page-left", _getButtonClassModifier(disabled)) },
    ...
    const _renderNextSection = () => {
        ...
        return (React.createElement("div", { onClick: nextFn, className: helpers_1.combineClassNames("paging_controller-button page-right", _getButtonClassModifier(disabled)) },
            React.createElement(Svgs_1.Chevron, { width: 8, height: 8, transform: "rotate(270)" })));
    };
    return (React.createElement("div", { className: "paging_controller-container" },
