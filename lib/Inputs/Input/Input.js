...
const Input = (props) => {
    ...
    const _computeInputClassname = (isMobile) => {
        const classes = [];
        if (className) {
    ...
    const _renderInput = (isMobile) => {
        ...
        return (React.createElement("div", { className: "input_input_wrapper" },
            ...
            React.createElement("input", Object.assign({ className: _computeInputClassname(isMobile), style: style, type: type ? type : "text", placeholder: placeholder ? placeholder : "", onChange: onChange
