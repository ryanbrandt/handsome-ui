...
const Input = (props) => {
    ...
    const _renderInput = () => {
        ...
        return (React.createElement("div", { className: "input_input_wrapper" },
            ...
            React.createElement("input", Object.assign({ className: _computeInputClassname(), style: style, type: type ? type : "text", placeholder: placeholder ? placeholder : "", onChange: onChange
