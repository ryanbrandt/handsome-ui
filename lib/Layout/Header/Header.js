...
const Header = (props) => {
    ...
    const [activeOption, setActiveOption] = React.useState(defaultActive);
    ...
    const _renderMobileItems = () => {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "app_mobile-content" },
                React.createElement(Layout_1.Column, null, options.map((option) => (React.createElement("h1", { key: option.name, onClick: () => handleItemClick(option) }, option.name)))))));
    };
    ...
    const _renderDefaultOptions = () => {
        const { options } = props;
        return (React.createElement("div", { className: "app_menu-options app_menu" }, options.map((option) => (React.createElement("span", { key: option.name, className: option.name === activeOption
    ...
    const _renderDefaultMenu = () => {
        return (React.createElement("div", { className: "app_header header-row" },
            React.createElement(Svgs_1.BurgerMenu, { className: menuOpen ? "app_menu-icon-active" : "app_menu-icon", onClick: () => setMenuOpen(!menuOpen) }),
