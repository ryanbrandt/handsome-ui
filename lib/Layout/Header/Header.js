...
const Header = (props) => {
    ...
    const _renderDefaultOptions = () => {
        const { options } = props;
        return (React.createElement("div", { className: "app_menu-options app_menu" },
            React.createElement(Svgs_1.Chevron, { className: "app_menu-escape", width: 20, height: 20, onClick: () => setMenuOpen(false) }),
            options.map((option) => (React.createElement("span", { key: option.name, className: option.name === activeOption
