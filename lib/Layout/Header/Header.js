...
const Header = (props) => {
    ...
    const _renderDefaultOptions = () => {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "app_menu-options app_menu" }, options.map((option) => (React.createElement("span", { key: option.name, className: option.name === activeOption
