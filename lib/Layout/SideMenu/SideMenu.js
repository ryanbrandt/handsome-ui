...
const SideMenu = (props) => {
    ...
    const _renderOptions = () => {
        const { options } = props;
        return options.map((option) => (React.createElement("div", { onClick: (e) => handleOptionClick(e, option), className: _computeOptionClassName(option) },
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(SideDrawer_1.default, { onClose: () => setOpen(false), visible: open },
            React.createElement("div", { className: "sidemenu_container" },
